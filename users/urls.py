...
from users.views import sign_up, log_in, log_out, no_permission, delete_user, update_user, user_list, change_role, create_group, update_group, delete_group
...
urlpatterns = [
    ...
    path('change-role/<user_id>/', change_role, name='change-role'),
