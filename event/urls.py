...
from event.views import dashboard, event_details, management_events, management_categories, management_participants, create_event, delete_event, update_event, create_category, delete_category,update_category, homepage
